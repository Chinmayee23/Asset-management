    ...
    <small class="text-muted"><?php echo $_SESSION['designation'];?></small>
        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <a class=" waves-effect">
                ...
                <a href="request_pendingp.php" class="list-group-item list-group-item-action waves-effect">
                    <i class="fa fa-table mr-3"></i>Requests Pending</a>
                <a href="asset_requestspr.php" class="list-group-item list-group-item-action waves-effect">
    ...
    <main class="pt-5 mx-lg-5">
        <div class="container-fluid mt-5">
            ...
            <div class="card mb-4 wow fadeIn">
				...
				$query="SELECT * FROM `requests` WHERE `status`='HOD Approved' ";
				...
				if($query_run=mysqli_query($connect,$query))
							{
								...
								else
								{
									while($row = mysqli_fetch_assoc($query_run)) 
									{
										...
										echo'
										<form class="text-center" action="koshish.php?ID='.$reqid.'&C=6" method="post" style="width:20%;">
